...
@if($sect == 'qualitative')
    ...
    <div class="container">
        ...
        <br>
        <form action = "{{ action('TestsController@qual_store') }}" method="POST" enctype="multipart/form-data">
...
@if($sect=='analytical')
    ...
    <div class="container">
      ...
      <br>
        <form action = "{{ action('TestsController@analy_store') }}" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
        <input type="hidden" value="{{$a}}" name="test_id">
        <input type="hidden" value="{{$b}}" name="test_n">
...
@if($sect=='creative')
    <div class="container">
        ...
        <br>
        <form action = "{{ action('TestsController@creat_store') }}" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
        <input type="hidden" value="{{$a}}" name="test_id">
        <input type="hidden" value="{{$b}}" name="test_n">
...
@if($sect=='comprehension')
    <div class="container">
       ...
       <br>
        <form action = "{{ action('TestsController@comp_store') }}" method="POST" enctype="multipart/form-data">
        <input type="hidden" name="_token" value="{{csrf_token()}}"/>
        <input type="hidden" value="{{$a}}" name="test_id">
        <input type="hidden" value="{{$b}}" name="test_n">
